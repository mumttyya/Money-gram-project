...
class UserContact(db.Model):
    ...
    nickname = db.Column(db.String(50), nullable=False)  # User submittable attribute
...
class Transaction(db.Model):
    ...
    transaction_type = db.Column(db.String(50), nullable=False)  # send_money, buy_airtime, pay_bill
...
class Account(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    user_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=False)
    account_type = db.Column(db.String(50), nullable=False)  # savings, checking, mobile_money
